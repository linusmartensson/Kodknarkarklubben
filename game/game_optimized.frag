...
void main ()
{
  ...
  if ((dt_3 < ((0.025 + 
    ...
    highp vec3 tmpvar_338;
    tmpvar_338 = (abs(po_298) - vec3(2.0, 0.3, 3.0));
    highp vec3 tmpvar_339;
    ...
    highp vec3 tmpvar_342;
    tmpvar_342 = (abs(poo_297) - vec3(0.9, 1.0, 3.3));
    highp vec3 tmpvar_343;
    ...
    highp vec4 tmpvar_423;
    tmpvar_423 = (1.79284 - (0.853735 * tmpvar_422));
    highp vec4 tmpvar_424;
    ...
    highp float tmpvar_439;
    tmpvar_439 = sin(t_437);
    highp mat2 tmpvar_440;
    ...
    highp float tmpvar_444;
    tmpvar_444 = sin(t_442);
    highp mat2 tmpvar_445;
    ...
    highp vec3 tmpvar_491;
    tmpvar_491 = (abs(po_451) - vec3(2.0, 0.3, 3.0));
    highp vec3 tmpvar_492;
    ...
    highp vec3 tmpvar_495;
    tmpvar_495 = (abs(poo_450) - vec3(0.9, 1.0, 3.3));
    highp vec3 tmpvar_496;
    ...
    highp vec4 tmpvar_576;
    tmpvar_576 = (1.79284 - (0.853735 * tmpvar_575));
    highp vec4 tmpvar_577;
    ...
    highp float tmpvar_592;
    tmpvar_592 = sin(t_590);
    highp mat2 tmpvar_593;
    ...
    highp float tmpvar_597;
    tmpvar_597 = sin(t_595);
    highp mat2 tmpvar_598;
    ...
    highp vec3 tmpvar_644;
    tmpvar_644 = (abs(po_604) - vec3(2.0, 0.3, 3.0));
    highp vec3 tmpvar_645;
    ...
    highp vec3 tmpvar_648;
    tmpvar_648 = (abs(poo_603) - vec3(0.9, 1.0, 3.3));
    highp vec3 tmpvar_649;
    ...
    highp vec4 tmpvar_729;
    tmpvar_729 = (1.79284 - (0.853735 * tmpvar_728));
    highp vec4 tmpvar_730;
    ...
    highp vec3 tmpvar_797;
    tmpvar_797 = (abs(po_757) - vec3(2.0, 0.3, 3.0));
    highp vec3 tmpvar_798;
    ...
    highp vec3 tmpvar_804;
    tmpvar_804 = (abs(poo_756) - vec3(0.9, 1.0, 3.3));
    highp vec3 tmpvar_805;
    ...
    highp vec4 tmpvar_882;
    tmpvar_882 = (1.79284 - (0.853735 * tmpvar_881));
    highp vec4 tmpvar_883;
    ...
    highp float tmpvar_897;
    tmpvar_897 = cos(t_896);
    highp float tmpvar_898;
    tmpvar_898 = sin(t_896);
    highp mat2 tmpvar_899;
    ...
    highp vec3 tmpvar_950;
    tmpvar_950 = (abs(po_910) - vec3(2.0, 0.3, 3.0));
    highp vec3 tmpvar_951;
    ...
    highp vec4 tmpvar_1035;
    tmpvar_1035 = (1.79284 - (0.853735 * tmpvar_1034));
    highp vec4 tmpvar_1036;
    ...
    highp float tmpvar_1050;
    tmpvar_1050 = cos(t_1049);
    highp float tmpvar_1051;
    tmpvar_1051 = sin(t_1049);
    highp mat2 tmpvar_1052;
    ...
    highp vec3 tmpvar_1103;
    tmpvar_1103 = (abs(po_1063) - vec3(2.0, 0.3, 3.0));
    highp vec3 tmpvar_1104;
